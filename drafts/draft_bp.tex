...
% \vspace*{6pt} \\ 
%     \noindent Keywords: [!!!]
%     \vspace*{6pt} \\ JEL classification codes: [!!!]  \vspace*{20pt} \\ 
%     \scriptsize{* Acknowledgements: We thank seminar participants at... and participants at... for their valuable comments on an earlier draft.  Any errors are our own.  Lumsdaine is grateful for the generous hospitality of the University of Portsmouth during various visits in contributing to the completion of this project;  in addition, parts of this project were completed while she was on partial secondment to the Office of Financial Research, United States Department of the Treasury, through an Intergovernmental Personnel Agreement (IPA) with American University. {\bf The views and opinions expressed are those of the authors only and do not necessarily represent the views of any institutions with which they are affiliated.}}
...
tincidunt. Lacinia at quis risus sed vulputate odio ut enim. \todo{This is a TODO in the margin.}
...
\caption{Example plot}
  \centering
  \includegraphics[width=0.6\linewidth]{\PathToOutput/example_plot.png}
